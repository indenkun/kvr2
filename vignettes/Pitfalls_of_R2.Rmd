...
vignette: >
  %\VignetteIndexEntry{he Pitfalls of R-square}
...
The `kvr2` package demonstrates that $R^2$ is not a "plug-and-play" statistic. By comparing these nine definitions, users can:

1. Identify when a model fit is being over- or under-represented by a specific formula.
2. Understand why Kvalseth recommended $R^2_1$ for its consistency and $R^2_9$ for its robustness.
3. Be more critical of $R^2$ values reported in scientific literature.
